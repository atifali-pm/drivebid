...
export default function Register() {
  ...
  async function handleRegister() {
    ...
    setLoading(true);
    try {
      await register(email, fullName, password, "driver");
  ...
  return (
    ...
    >
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Join DriveBid and start driving</Text>
        <TextInput
        ...
        />
        <TextInput
          style={styles.input} placeholder="Password (min 6 chars)"
